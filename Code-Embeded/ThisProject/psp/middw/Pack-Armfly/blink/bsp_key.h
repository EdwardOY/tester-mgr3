...
//s>--edwoy---------
//	void* mArg;  //custom button argument
//	pFunc_CtmBtn_t  mFunc;
//e<--edwoy---------
}X_GPIO_T;


extern const X_GPIO_T g_keys_list[HARD_KEY_NUM] ;	
	 
#endif //<#elif CMPL_THISPROJ == CMPL_EDWOY>

// 根据应用程序的功能重命名按键宏 
#define KEY_DOWN_K0		KEY_0_DOWN //edwoy260503
...
#define KEY_DOWN_WKUP   WKUP_DOWN
#define KEY_UP_WKUP		WKUP_UP
#define KEY_LONG_WKUP	WKUP_LONG
...
//	KID_NONE = 0,
	...
	KID_K1,
	KID_K2,
	KID_WKUP, //raw is K3 ,edwoy260503
	KID_MAX,  //add,edwoy260503
...
// 按键FIFO用到变量 
#define KEY_FIFO_SIZE   4  //raw is 10,edwoy260503
