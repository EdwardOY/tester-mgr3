 ...
 *	V2.5 20110930
 *	1,修改usmart_init函数为void usmuint8_tt_init(u8 sysclk),可以根据系统频率自动设定扫描时间.(固定100ms)
 ...
 *
 * @return  uint8_t		0，成功转换完成.其他,错误代码
 ...
 * @param   str		源字符串指针
 * @param   fparm	参数字符串指针
 * @param   ptype	参数类型 0，数字;1，字符串;0XFF，参数错误
 *
 * @return  uint8_t		0,已经无参数了;其他,下一个参数的偏移量
 */
