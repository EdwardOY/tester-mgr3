 ...
 * @param   void
 *
 * @return  uint32_t		执行时间,单位:0.1ms,最大延时时间为定时器CNT值的2倍*0.1ms
 */
 ...
 * @brief	定时器4中断服务程序
 *
 * @remark	这个函数,非USMART函数,放到这里,仅仅方便移植.
 *
 * @param   void
 *
 * @return  void
