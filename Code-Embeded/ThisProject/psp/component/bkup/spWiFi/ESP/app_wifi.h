 ...
 * @version     V1.0
 * @date        2021-10-27
 * @brief       Bluetooth&BLE resource h of serialport communication
...
///==LMBT Setting==================================================================================
//---dev-state---------------------------------------------------------------------------
extern emBTBLE_DevState_t g_atkmoudle_btble_devsta;
//---end dev-state-----------------------------------------------------------------end---
...
#define IS_VALID_PWR_LMBT(x)   ((LMBT_PwrGrd_N15DBM == x) || (LMBT_PwrGrd_N12DBM == x) || (LMBT_PwrGrd_N10DBM == x) || \
...
//    LMBT_DeepSleep_En  = 10,       // 深度睡眠 
	  LMBT_DeepSleep_Max = 200,      // Max ms to enter deepsleep
	  LMBT_DeepSleep_CHK = 0xcf,     // check cmd
} emLMBT_DeepSleep_t;
#define IS_VALID_DEEPSLP_LMBT(x)   ((LMBT_DeepSleep_Dis < x) && (LMBT_DeepSleep_Max >= x)) 
///--end power mode-------------------------------------------------------------------end---
